...
{
    struct SinglyLinkedListNode *ptr1, *ptr2;
    ptr1 = (struct SinglyLinkedListNode *)malloc(sizeof(struct SinglyLinkedListNode));
    ptr2 = (struct SinglyLinkedListNode *)malloc(sizeof(struct SinglyLinkedListNode));
